      ...
      <main className="flex-1 w-full max-w-3xl px-6 pt-8 mb-0 mx-auto md:px-8 md:pt-16">
        <section>
          ...
          <div className="prose mb-12">
            <p>
              We appreciate it! Check your email for more details and a link to manage your subscription.
            </p>

            <p><strong>To get started, here is your API key:</strong></p>

            <pre><code>{apiKey}</code></pre>

            <p>You can use it like this:</p>

            <pre><code>&lt;img src=&quot;https://thumbnails.cloud/v1/jpg?token={apiKey}&amp;url=https://lowcdn.com/2x/bf7/598f234dbb76-0037a0222e/example.doc&quot; /&gt;</code></pre>
          </div>

          <Link to="/thumbnails-cloud/#usage" className="text-blue-500 underline">More details</Link>
        </section>
      </main>
    </div>
  );
