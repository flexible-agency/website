...
function ThumbnailsCloudPage() {
      ...
      <div className="flex flex-col min-h-screen font-sans leading-normal text-gray-900">
        ...
        <main className="flex-1 w-full max-w-3xl px-8 pt-8 mb-0 mx-auto md:pt-16">
          <section>
            ...
            <p className="prose">
              The thumbnails.cloud API generates JPEG file previews for all
              common document formats, using a simple API. Get an API token for
              $9/mo for personal and small-scale projects, and create an
              unlimited number of preview images! For large-scale and enterprise
              licensing, please{" "}
  ...
  &mode=crop`}</code>
              ...
              <table className="is-bordered">
                ...
                <tbody className="prose">
                  ...
                  <tr>
                    ...
                    <td />
                    <td>
                      Pixel width of your thumbnail. Defaults to{" "}
                      <code>600</code>.
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td />
                    <td>
                      For documents, specify where the gravity lies for
                      cropping. Options: <code>North</code>, <code>South</code>,{" "}
                  ...
                  <tr>
                    ...
                    <td />
                    <td>
                      By default, an image is returned. Specify{" "}
                      <code>json</code> to get back a base64 encoded version in
                      a JSON object.
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      offset higher than the duration of the video, the
            ...
            <p className="prose">
              ...
              up-to-date overview of the supported file extensions. Note that
              this refers to the file types that can be converted into JPG, PDF
              support is currently slightly more limited.
            </p>
            <h2 className="text-2xl font-bold mt-10 mb-3">
            ...
            <p className="prose">
              ...
              create previews for potentially confidential documents.
              That&apos;s why we don&apos;t log the URLs of the documents you
              convert, nor do we keep the original documents after we&apos;ve
              converted them.
            </p>
